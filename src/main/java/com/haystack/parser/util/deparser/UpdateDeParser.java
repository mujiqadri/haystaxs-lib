 ...
 * string) an {@link com.haystack.parser.statement.update.Update}
 */
    ...
    public void deParse(Update update) {
        ...
        if (!update.isUseSelect()) {
            for (int i = 0; i < update.getColumns().size(); i++) {
                ...
                expression.accept(expressionVisitor,"0");
            ...
            select.getSelectBody().accept(selectVisitor,"0");
            buffer.append(")");
        }
        ...
        if (update.getWhere() != null) {
            buffer.append(" WHERE ");
            update.getWhere().accept(expressionVisitor,"0");
        }
