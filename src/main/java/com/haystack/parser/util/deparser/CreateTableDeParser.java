...
import com.haystack.parser.statement.create.table.ColumnDefinition;
import com.haystack.parser.statement.create.table.CreateTable;
import com.haystack.parser.statement.create.table.Index;
import com.haystack.parser.statement.select.PlainSelect;

/**
 * A class to de-parse (that is, tranform from JSqlParser hierarchy into a
 * string) a {@link com.haystack.parser.statement.create.table.CreateTable}
 */
