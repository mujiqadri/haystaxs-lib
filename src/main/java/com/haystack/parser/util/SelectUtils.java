...
import com.haystack.parser.statement.select.AllColumns;
import com.haystack.parser.statement.select.Join;
...
import com.haystack.parser.statement.select.SelectItem;
import com.haystack.parser.statement.select.SelectVisitor;
import com.haystack.parser.statement.select.SetOperationList;
...
public final class SelectUtils {
	 ...
	 * @param expr
	 * @return 
	 * @throws com.haystack.parser.JSQLParserException
	 */
	...
	public static void addExpression(Select select, final Expression expr) {
		select.getSelectBody().accept(new SelectVisitor() {
			...
			@Override
			public void visit(SetOperationList setOpList, String level) {
