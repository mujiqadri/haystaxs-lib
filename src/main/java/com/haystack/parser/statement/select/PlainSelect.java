...
import com.haystack.parser.expression.OracleHierarchicalExpression;
...
public class PlainSelect implements SelectBody {
    ...
    @Override
    public void accept(SelectVisitor selectVisitor, String level) {
        selectVisitor.visit(this, level);
    }
