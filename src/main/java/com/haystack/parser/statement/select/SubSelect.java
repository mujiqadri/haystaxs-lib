...
public class SubSelect implements FromItem, Expression, ItemsList {
	...
	@Override
	public void accept(FromItemVisitor fromItemVisitor , String level) {
		fromItemVisitor.visit(this, level);
	}
	...
	@Override
	public void accept(ItemsListVisitor itemsListVisitor , String level) {
		itemsListVisitor.visit(this, level);
	}
