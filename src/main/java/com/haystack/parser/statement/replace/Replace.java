 ...
 * #L%
 */
package com.haystack.parser.statement.replace;

import java.util.List;

import com.haystack.parser.expression.Expression;
import com.haystack.parser.expression.relational.ItemsList;
...
public class Replace implements Statement {
	...
	/**
	 * A list of {@link com.haystack.parser.schema.Column}s either from a "REPLACE
	 * mytab (col1, col2) [...]" or a "REPLACE mytab SET col1=exp1, col2=exp2".
	 *
	 * @return a list of {@link com.haystack.parser.schema.Column}s
	 */
	...
	/**
	 * A list of {@link com.haystack.parser.expression.Expression}s (from a
